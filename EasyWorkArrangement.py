...
def createEasyArrangement():
    for day in dayOptionsList:
        if isinstance(day, DayOptions):
            print(day.morningOptionsSet)
        #balanceList = getBalanceData()      # Refresh the balance data from the current month
    return 0
